...
const Services = () => {
  ...
  return (
    <>
      ...
      <div class="bg-white py-16 font-sans">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p class="text-sm font-semibold uppercase tracking-wider text-[#E5B6A7] flex items-center justify-center mb-4">
            OUR TREATMENT SPECIAL
          </p>
          <h2 class="text-5xl md:text-6xl font-serif text-gray-800 leading-tight mb-12">
            Treats Your Soul
          </h2>

          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="relative bg-white border border-gray-200 rounded-xl p-6 h-[220px] flex flex-col justify-center items-center text-center shadow-sm hover:shadow-md transition-all duration-300 group">
              <img className='w-30' src={massage2} alt="" />
              <h3 class="text-xl font-semibold text-gray-800 mt-2">Medi Facial</h3>

            </div>

            <div class="relative bg-white border border-gray-200 rounded-xl p-6 h-[220px] flex flex-col justify-center items-center text-center shadow-sm hover:shadow-md transition-all duration-300 group">
              <img className='w-30' src={heal} alt="" />
              <h3 class="text-xl font-semibold text-gray-800 mt-2">Youth Preserve</h3>

            </div>

            <div class="relative bg-white border border-gray-200 rounded-xl p-6 h-[220px] flex flex-col justify-center items-center text-center shadow-sm hover:shadow-md transition-all duration-300 group">
              <img className='w-30' src={wash} alt="" />
              <h3 class="text-xl font-semibold text-gray-800 mt-2">Body Sculpting</h3>

            </div>

            <div class="relative bg-white border border-gray-200 rounded-xl p-6 h-[220px] flex flex-col justify-center items-center text-center shadow-sm hover:shadow-md transition-all duration-300 group">
              <img className='w-30' src={facial} alt="" />
              <h3 class="text-xl font-semibold text-gray-800 mt-2">Hair Restore</h3>
      ...
      <div className="bg-[#F8F5F1] py-16 px-4 md:px-8 font-sans">
        <div className="max-w-7xl mx-auto space-y-20">
          {alternatingServices.map((service, index) => (
            <div key={index} className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className={service.imageRight ? 'md:order-2' : 'md:order-1'}>
                <img src={service.image} alt={service.title} className="w-full h-auto rounded-xl shadow-lg" />
              </div>
              <div className={service.imageRight ? 'md:order-1' : 'md:order-2'}>
                <h3 className="text-2xl font-bold text-[#A5783A] mb-4">{service.title}</h3>
